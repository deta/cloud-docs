...
sidebar_label: About
---
Deta Base is a fast, scalable and secure NoSQL database.

You can store up to 3GB for free.

What can I use Deta Base for?

Deta Base is great for smaller projects where configuring a database is an overkill. 

Examples:
-Internal tools and side project
